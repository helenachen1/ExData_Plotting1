...
# Plot 4.1
plot(dataset$Date_time,dataset$Global_active_power, ylab="Global Active Power (kilowatts)", 
     xlab="", pch =".", type="l")

# Plot 4.2
plot(dataset$Date_time,dataset$Voltage, ylab="Voltage", xlab="datetime", type="l")
...
legend("topright", lwd=1, col=c("black", "red", "blue"), legend=names(dataset[,7:9]), bty="n")
# Plot 4.4
plot(dataset$Date_time,dataset$Global_reactive_power, ylab="Global_reactive_power", xlab="datetime", type="l")
